...
if (window.location.href == "https://sis.rpi.edu/rss/bwpkdcmn.P_DispDednCurFlxs") {
    ...
    // Adjustments to the paragraph above the table
    document.getElementsByClassName("infotexttable")[0].innerHTML = 'Below is your current spending account information.<br>For information about Flexible (Medical and/or Dependent Care) Spending Accounts please visit Flexible Spending Accounts, and for information on current balances or outstanding claims please contact <a href="https://rpi.connectyourcare.com/portal/CC?rnd=1397068192558">ConnectYourCare.</a>';
}
if (window.location.href == "https://sis.rpi.edu/rss/bwpkdcmn.P_DispDednCurMisc") {
    ...
    // Adjustments to the paragraph above the table
    document.getElementsByClassName("infotexttable")[0].innerHTML = "This is a list of your additional benefits.<br><br>Note: Rensselaer provides Basic Life Insurance to eligible employees. This program provides term life insurance equal to 2.25 times your July 1 rate of pay or your prior calendar year Rensselaer earnings.";
}
